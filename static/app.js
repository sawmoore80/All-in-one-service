...
function renderKPIs(k){
  const items=[{label:'Total Spend',value:currency(k.total_spend)},{label:'Avg ROAS',value:(k.avg_roas??0).toFixed?.(2)??String(k.avg_roas||0)},{label:'Avg CPA',value:currency(k.avg_cpa)},{label:'Conversions',value:(k.conversions||0).toLocaleString()}];
